...
<html>
  <head>
    ...
    <title>My JSP 'Analyse6.jsp' starting page</title>
			...
			<div class=results-detail">
				...
				<div style="border-bottom:1px solid #eeeeff;padding:5px 0 10px;">
					...
					<% int[][]array= new int[24][8];
						...
						6. 题目<span style="color:#0066FF;">&nbsp;&nbsp;</span>[单选题]1
					</div>
					<div style="margin-top:5px;">
						...
						<table class="tableResult" id="table-result"
							...
							<%
								...
								double i1=100*(double)array[5][0]/(array[5][0]+array[5][1]+array[5][2]+array[5][3]+array[5][4]);
								double i2=100*(double)array[5][1]/(array[5][0]+array[5][1]+array[5][2]+array[5][3]+array[5][4]);
								double i3=100*(double)array[5][2]/(array[5][0]+array[5][1]+array[5][2]+array[5][3]+array[5][4]);
								double i4=100*(double)array[5][3]/(array[5][0]+array[5][1]+array[5][2]+array[5][3]+array[5][4]);
								double i5=100*(double)array[5][4]/(array[5][0]+array[5][1]+array[5][2]+array[5][3]+array[5][4]);
							 %>
