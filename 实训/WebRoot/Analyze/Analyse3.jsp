...
<html>
  <head>
    ...
    <title>My JSP 'Analyse3.jsp' starting page</title>
			...
			<div class=results-detail">
				...
				<div style="border-bottom:1px solid #eeeeff;padding:5px 0 10px;">
					...
					<% int[][]array= new int[24][8];
						...
						3. 题目<span style="color:#0066FF;">&nbsp;&nbsp;</span>[单选题]1
					</div>
					<div style="margin-top:5px;">
						...
						<table class="tableResult" id="table-result"
							...
							<%
								...
								double i1=100*(double)array[2][0]/(array[2][0]+array[2][1]+array[2][2]+array[2][3]+array[2][4]);
								double i2=100*(double)array[2][1]/(array[2][0]+array[2][1]+array[2][2]+array[2][3]+array[2][4]);
								double i3=100*(double)array[2][2]/(array[2][0]+array[2][1]+array[2][2]+array[2][3]+array[2][4]);
								double i4=100*(double)array[2][3]/(array[2][0]+array[2][1]+array[2][2]+array[2][3]+array[2][4]);
								double i5=100*(double)array[2][4]/(array[2][0]+array[2][1]+array[2][2]+array[2][3]+array[2][4]);
							 %>
