...
<html>
  <head>
    ...
    <title>My JSP 'Analyse7.jsp' starting page</title>
			...
			<div class=results-detail">
				...
				<div style="border-bottom:1px solid #eeeeff;padding:5px 0 10px;">
					...
					<% int[][]array= new int[24][8];
						...
						7. 题目<span style="color:#0066FF;">&nbsp;&nbsp;</span>[单选题]1
					</div>
					<div style="margin-top:5px;">
						...
						<table class="tableResult" id="table-result"
							...
							<%
								...
								double i1=100*(double)array[6][0]/(array[6][0]+array[6][1]+array[6][2]+array[6][3]+array[6][4]);
								double i2=100*(double)array[6][1]/(array[6][0]+array[6][1]+array[6][2]+array[6][3]+array[6][4]);
								double i3=100*(double)array[6][2]/(array[6][0]+array[6][1]+array[6][2]+array[6][3]+array[6][4]);
								double i4=100*(double)array[6][3]/(array[6][0]+array[6][1]+array[6][2]+array[6][3]+array[6][4]);
								double i5=100*(double)array[6][4]/(array[6][0]+array[6][1]+array[6][2]+array[6][3]+array[6][4]);
							 %>
